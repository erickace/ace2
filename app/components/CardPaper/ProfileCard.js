  ...
  render() {
    ...
    return (
      <Card className={classes.cardSocmed}>
        <CardMedia
          className={classes.MyCoverCard}
          image={cover}
          title="cover"
        />
        <CardContent className={classes.contentProfile, classes.MyCurrentEndCard}>
          <Avatar alt="avatar" src={avatar} className={classes.MyAvatarCard} />

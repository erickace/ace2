...
function activateOutput(){
  ...
  localStorage.removeItem("esCoach");
  localStorage.removeItem("nac");
  localStorage.removeItem("idUsuarioLogin");
  localStorage.removeItem("DateU");
}
  ...
  return (
    <div>
      ...
      <Menu
        ...
        onClose={handleClose}
      >
        <MenuItem onClick={handleClose} component={Link} to="/app/my-profile">My Profile</MenuItem>
        ...
        <Divider />
        <MenuItem onClick={handleClose} component={Link} onClick={activateOutput} to="/">
          <ListItemIcon>
            <ExitToApp />
          </ListItemIcon>
          Log Out
